...
const DEVICE_PAYLOAD = process.env.DEVICES_PAYLOAD || 'json';
...
//     Security.oa
//         .getOAuthPasswordCredentials(process.env.DEVICES_USER, process.env.DEVICES_PASSWORD)
//         .then((results) => {
...
let Measure;
const headers = {};
// if (process.env.DEVICES_USER && process.env.DEVICES_PASSWORD) {
