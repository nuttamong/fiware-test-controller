...
const TRANSPORT = process.env.DEVICES_TRANSPORT || 'HTTP';
...
const NOTIFY_ATTRIBUTES = ['refStore']//, 'refProduct', 'refShelf', 'type', 'locatedIn', 'stocks'];//edit
//edit
const NGSI_V2_STORES = [
    {
        href: 'app/store/urn:ngsi-ld:Test:001',
        name: 'Test 1'
    }
];
